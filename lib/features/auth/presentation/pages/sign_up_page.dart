...
import 'package:senpai_lib/features/auth/presentation/components/custom_text.dart';
import 'package:senpai_lib/features/auth/presentation/components/custom_text_field.dart';
import 'package:senpai_lib/features/auth/presentation/pages/sign_in_page.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget _buildTextField(TextEditingController controller, String label, IconData icon, {bool obscureText = false}) {
    return CustomTextField(controller: controller, label: label, icon: icon, obscureText: obscureText, darkMode: true,);
    }
    }